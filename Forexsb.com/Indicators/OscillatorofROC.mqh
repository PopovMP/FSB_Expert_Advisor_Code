...
class OscillatorofROC : public Indicator
  {
public:
    OscillatorofROC(SlotTypes slotType)
     {
      SlotType=slotType;
...
//|                                                                  |
//+------------------------------------------------------------------+
void OscillatorofROC::Calculate(DataSet &dataSet)
  {
...
// ----------------------------------------------------
   ...
   roc1.ListParam[2].Index = ListParam[2].Index;
   roc1.NumParam[0].Value=NumParam[0].Value;
   roc1.CheckParam[0].Checked=CheckParam[0].Checked;
   roc1.Calculate(dataSet);

   RateofChange *roc2=new RateofChange(SlotType);
   roc2.ListParam[1].Index = ListParam[1].Index;
   roc2.ListParam[2].Index = ListParam[2].Index;
   roc2.NumParam[0].Value=NumParam[1].Value;
   roc2.CheckParam[0].Checked=CheckParam[0].Checked;
   ...
   ArrayCopy(adIndicator2,roc2.Component[0].Value);
// -----------------------------------------------------

   int firstBar=0;
   for(int c=0; c<roc1.Components(); c++)
   {
       if (firstBar<roc1.Component[c].FirstBar)
           firstBar=roc1.Component[c].FirstBar;
       if (firstBar<roc2.Component[c].FirstBar)
           firstBar=roc2.Component[c].FirstBar;
   }
   firstBar+=3;
