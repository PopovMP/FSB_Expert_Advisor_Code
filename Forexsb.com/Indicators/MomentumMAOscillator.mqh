...
class MomentumMAOscillator : public Indicator
  {
public:
                     MomentumMAOscillator(SlotTypes slotType);
   virtual void      Calculate(DataSet &dataSet);
  };
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
void MomentumMAOscillator::MomentumMAOscillator(SlotTypes slotType)
  {
   SlotType          = slotType;
   IndicatorName     = "Momentum MA Oscillator";
   WarningMessage    = "";
   IsAllowLTF        = true;
...
//|                                                                  |
//+------------------------------------------------------------------+
void MomentumMAOscillator::Calculate(DataSet &dataSet)
  {
...
// ----------------------------------------------------
   ...
   momentum1.ListParam[2].Index = ListParam[3].Index;
