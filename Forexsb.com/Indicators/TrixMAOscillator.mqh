...
// ----------------------------------------------------
   ...
   double adIndicator2[];
   MovingAverage(period2,0,signalMAMethod,indicator1,adIndicator2);
// -----------------------------------------------------

   for(int bar=firstBar; bar<Data.Bars; bar++)
      oscillator[bar]=indicator1[bar]-adIndicator2[bar];
...
// Calculation of the logic
   ...
   OscillatorLogic(firstBar,prvs,oscillator,0,0,Component[1],Component[2],indLogic);
  }
//+------------------------------------------------------------------+
