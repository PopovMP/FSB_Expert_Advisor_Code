...
class OscillatorofBBP : public Indicator
  {
public:
    OscillatorofBBP(SlotTypes slotType)
     {
      SlotType=slotType;
...
//|                                                                  |
//+------------------------------------------------------------------+
void OscillatorofBBP::Calculate(DataSet &dataSet)
  {
...
// ----------------------------------------------------
   BullsBearsPower *bbp1=new BullsBearsPower(SlotType);

   bbp1.ListParam[1].Index= ListParam[1].Index;
   bbp1.NumParam[0].Value = NumParam[0].Value;
   bbp1.CheckParam[0].Checked=CheckParam[0].Checked;
   bbp1.Calculate(dataSet);

   BullsBearsPower *bbp2=new BullsBearsPower(SlotType);

   bbp2.ListParam[1].Index= ListParam[1].Index;
   bbp2.NumParam[0].Value = NumParam[1].Value;
   bbp2.CheckParam[0].Checked=CheckParam[0].Checked;
   bbp2.Calculate(dataSet);

   double adIndicator1[];
   ArrayResize(adIndicator1,Data.Bars);
   ArrayCopy(adIndicator1,bbp1.Component[0].Value);
   double adIndicator2[];
   ArrayResize(adIndicator2,Data.Bars);
   ArrayCopy(adIndicator2,bbp2.Component[0].Value);
// -----------------------------------------------------

   int firstBar=0;
   for(int c=0; c<bbp1.Components(); c++)
   {
