...
class RSIMAOscillator : public Indicator
  {
public:
   RSIMAOscillator(SlotTypes slotType)
     {
      SlotType=slotType;
...
//|                                                                  |
//+------------------------------------------------------------------+
void RSIMAOscillator::Calculate(DataSet &dataSet)
  {
...
// ----------------------------------------------------
   ...
   rsi1.ListParam[2].Index = ListParam[3].Index;
   ...
   ArrayCopy(adIndicator1,rsi1.Component[0].Value);
   delete rsi1;
...
// Calculation of the logic
   ...
   if(ListParam[0].Text=="RSI MA Oscillator rises")
      indLogic=IndicatorLogic_The_indicator_rises;
   else if(ListParam[0].Text=="RSI MA Oscillator falls")
      indLogic=IndicatorLogic_The_indicator_falls;
   else if(ListParam[0].Text=="RSI MA Oscillator is higher than the zero line")
      indLogic=IndicatorLogic_The_indicator_is_higher_than_the_level_line;
   else if(ListParam[0].Text=="RSI MA Oscillator is lower than the zero line")
      indLogic=IndicatorLogic_The_indicator_is_lower_than_the_level_line;
   else if(ListParam[0].Text=="RSI MA Oscillator crosses the zero line upward")
      indLogic=IndicatorLogic_The_indicator_crosses_the_level_line_upward;
   else if(ListParam[0].Text=="RSI MA Oscillator crosses the zero line downward")
      indLogic=IndicatorLogic_The_indicator_crosses_the_level_line_downward;
   else if(ListParam[0].Text=="RSI MA Oscillator changes its direction upward")
      indLogic=IndicatorLogic_The_indicator_changes_its_direction_upward;
   else if(ListParam[0].Text=="RSI MA Oscillator changes its direction downward")
