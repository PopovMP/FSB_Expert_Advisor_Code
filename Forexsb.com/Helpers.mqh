...
string SameDirSignalActionToString(SameDirSignalAction action)
  {
   switch(action)
     {
      case SameDirSignalAction_Add:     return "Add";
      case SameDirSignalAction_Winner:  return "Winner";
      case SameDirSignalAction_Loser:   return "Loser";
      case SameDirSignalAction_Nothing: return "Nothing";
     }
   return "";
  }
//+------------------------------------------------------------------+
...
string OppositeDirSignalActionToString(OppositeDirSignalAction action)
  {
   switch(action)
     {
      case OppositeDirSignalAction_Close:   return "Close";
      case OppositeDirSignalAction_Nothing: return "Nothing";
      case OppositeDirSignalAction_Reduce:  return "Reduce";
      case OppositeDirSignalAction_Reverse: return "Reverse";
     }
   return "";
  }
//+------------------------------------------------------------------+
...
SlotTypes SlotTypeFromShortString(string shortString)
  {
   if(shortString == "Open")        return (SlotTypes_Open);
   if(shortString == "OpenFilter")  return (SlotTypes_OpenFilter);
   if(shortString == "Close")       return (SlotTypes_Close);
   if(shortString == "CloseFilter") return (SlotTypes_CloseFilter);
